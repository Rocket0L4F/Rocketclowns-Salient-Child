	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="button alt" id="place_order" value="Proceed with Payment" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>
